    ...
    public partial class RazorSourceGenerator : IIncrementalGenerator
    {
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            var tagHelpersFromCompilation = context.CompilationProvider
                ...
                .WithLambdaComparer(static (a, b) =>
                {
                    var (_, razorSourceGeneratorOptionsB) = b;
            ...
            var tagHelpersFromReferences = context.CompilationProvider
                ...
                .WithLambdaComparer(static (a, b) =>
                {
                    ...
                    if (razorSourceGeneratorOptionsB.SuppressRazorSourceGenerator)
                    {
                    ...
                    if (!razorSourceGeneratorOptionsA.Equals(razorSourceGeneratorOptionsB))
                    {
                        return false;
                    }
            ...
            var generatedOutput = sourceItems
                ...
                .WithLambdaComparer(static (a, b) =>
                {
                    var (_, razorSourceGeneratorOptions) = b;

                    return razorSourceGeneratorOptions.SuppressRazorSourceGenerator || a.Equals(b);
                }, static item =>
                {
                    var (left, _) = item;
                    return left.GetHashCode();
